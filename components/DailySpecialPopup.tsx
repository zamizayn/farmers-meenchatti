...
const DailySpecialPopup: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-[100] animate-in slide-in-from-bottom-5 duration-500">
            <div className="bg-sky-600 text-white p-4 shadow-[0_-10px_40px_rgba(0,0,0,0.2)] border-t border-sky-400 relative overflow-hidden">
                {/* Background Pattern */}
                <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#fff_1px,transparent_1px)] [background-size:16px_16px]"></div>

                <div className="container mx-auto px-6 flex items-center justify-between gap-4 relative z-10">
                    <div className="flex items-center gap-4">
                        <span className="bg-white text-sky-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest animate-pulse">Todays Special</span>
